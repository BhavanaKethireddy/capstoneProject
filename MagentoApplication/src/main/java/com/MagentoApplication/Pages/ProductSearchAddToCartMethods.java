...
import com.MagentoApplication.Locators.ProductSearchAddToCartObjects;
import com.aventstack.extentreports.Status;
public class ProductSearchAddToCartMethods extends browser{
    ...
    public static void selectingSearchData(String str) {
        ...
        //logger1 = extent.createTest("Product Suggestions");
		logger1.log(Status.INFO, "Displaying product suggestions");
        try {
            boolean found = false;
                ...
                if (productText.equalsIgnoreCase(str)) {
                    if (suggestion.isDisplayed() && suggestion.isEnabled()) {
                        try {
                            ...
                            found = true;
                            logger1.log(Status.PASS, "Product Suggestions dispalyed successfully");
                            break;
                        } catch (Exception e) {
                        	logger1.log(Status.FAIL, "Product Suggestions displaying  failed");
